...
<html>
    ...
    <body style=" background: url(image/bg_Admin.png)  center fixed; background-size: single;text-align: center;">
    <!-- 使用bootstrap框架-->
    ...
    <div class="pageContainer">
         ...
         <div class="pageSidebar" >
             <ul class="nav nav-stacked nav-pills">     
                 ...
                 <li role="presentation">
                     <a href="welcome.jsp" target="mainFrame" >项目介绍</a>
                 </li>                
                 ...
                 <li role="presentation">
                     <a href="Insert.jsp" target="mainFrame" >添加数据</a>
                 </li>
                 <li role="presentation">
                     <a href="Update.jsp" target="mainFrame">修改数据</a>
                 </li>
                 <li role="presentation">
                     <a href="Remove.jsp" target="mainFrame">删除数据</a>
                 </li>
                 <li role="presentation">
