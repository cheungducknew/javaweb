...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!--删除行js-->
    <script src="js/Remove.js"  language="javascript"></script>
</head>
...
<body style=" background: rgba(255,255,255,0); background-size: single;text-align: center;">
    ...
    <div class="container" >
        <br>
        <h1> 删除数据操作页面</h1>
        <form role="form" name="form1" action="${pageContext.request.contextPath }/RemoveServlet" method = "get">
            <!--函数功能的input，hidden掉了-->
        ...
        <input  class="btn btn-danger" type="button" value="删除选中行" onclick="RemoveRow()">
